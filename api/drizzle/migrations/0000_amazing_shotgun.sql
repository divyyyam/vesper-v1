...
ALTER TABLE "appointments" ADD CONSTRAINT "appointments_lawyer_id_lawyers_id_fk" FOREIGN KEY ("lawyer_id") REFERENCES "public"."lawyers"("id") ON DELETE no action ON UPDATE no action;