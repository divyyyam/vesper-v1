...
export default function RegisterPage() {
  return (
    <div className="flex min-h-screen items-center justify-center p-6 bg-[#0b0f19] text-slate-100 relative overflow-hidden">
      ...
      <div className="w-full max-w-md flex flex-col gap-6 bg-slate-900/80 backdrop-blur-xl p-8 rounded-2xl border border-slate-800/80 shadow-2xl shadow-purple-950/20 relative z-10">
        <div className="flex justify-center mb-2">
          <a href="/" className="flex items-center gap-2 font-bold text-xl text-slate-100 hover:text-blue-400 transition-colors">
            <div className="bg-gradient-to-br from-blue-500 to-purple-600 text-white flex size-9 items-center justify-center rounded-xl shadow-md">
